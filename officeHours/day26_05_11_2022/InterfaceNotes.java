...
public class InterfaceNotes {
    ...
    = Interface =
		...
		-  Interfaces can have:
					...
					• Default Methods --> Similar to instance methods
					    - Can be overriden
					• Static Methods
...
- Inheritance
	- Abstract classes can extend a single abstract or non-abstract class and implement interface(s)
