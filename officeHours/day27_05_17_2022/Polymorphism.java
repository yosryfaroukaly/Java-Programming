...
= Poly + Morphism ( Many Forms) =
	...
	- One Object has different forms
...
= Rules =
	...
	NOTE : Reference types decide what is accessible



 = instanceof =

	• instanceof operator can be used to check if the object is certain class.It returns bollean result as true or false
